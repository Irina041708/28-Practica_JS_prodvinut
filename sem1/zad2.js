...
// Создайте объект library, который содержит массив книг
// и имеет свойство-символ Symbol.iterator.
// Реализуйте кастомный итератор для объекта library.
// Итератор должен перебирать книги по порядку.
...
const library = {
  books: [...books],//распарсили и взяли обратно в массив
